...
import jcifsng.internal.smb2.session.Smb2LogoffRequest;
...
final class SmbSessionImpl implements SmbSessionInternal {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbSession#unwrap(java.lang.Class)
     */
    ...
    private static boolean isExternalAuth ( CIFSContext tc, NtlmPasswordAuthenticator npa ) {
        return npa instanceof jcifsng.smb.NtlmPasswordAuthentication && ( (NtlmPasswordAuthentication) npa ).areHashesExternal()
