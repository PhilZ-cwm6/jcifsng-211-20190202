...
import jcifsng.ntlmssp.NtlmFlags;
import jcifsng.ntlmssp.Type1Message;
import jcifsng.ntlmssp.Type2Message;
import jcifsng.ntlmssp.Type3Message;
...
public class NtlmContext implements SSPContext {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#getSupportedMechs()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#getFlags()
     */
    @Override
    public int getFlags () {
        return 0;
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#isSupported(org.bouncycastle.asn1.ASN1ObjectIdentifier)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#isPreferredMech(org.bouncycastle.asn1.ASN1ObjectIdentifier)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SSPContext#dispose()
     */
    @Override
