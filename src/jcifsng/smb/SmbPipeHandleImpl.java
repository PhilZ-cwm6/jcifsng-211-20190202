...
import jcifsng.SmbPipeHandle;
import jcifsng.SmbPipeResource;
import jcifsng.internal.smb1.trans.TransCallNamedPipe;
import jcifsng.internal.smb1.trans.TransCallNamedPipeResponse;
import jcifsng.internal.smb1.trans.TransTransactNamedPipe;
import jcifsng.internal.smb1.trans.TransTransactNamedPipeResponse;
import jcifsng.internal.smb1.trans.TransWaitNamedPipe;
import jcifsng.internal.smb1.trans.TransWaitNamedPipeResponse;
import jcifsng.internal.smb2.ioctl.Smb2IoctlRequest;
import jcifsng.internal.smb2.ioctl.Smb2IoctlResponse;
import jcifsng.util.ByteEncodable;
...
class SmbPipeHandleImpl implements SmbPipeHandleInternal {
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#unwrap(java.lang.Class)
     */
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#getPipe()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#isOpen()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SmbPipeHandleInternal#getSessionKey()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#isStale()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#getInput()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#getOutput()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SmbPipeHandleInternal#sendrecv(byte[], int, int, byte[], int)
     */
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.smb.SmbPipeHandleInternal#getPipeType()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see jcifsng.SmbPipeHandle#close()
     */
    @Override
