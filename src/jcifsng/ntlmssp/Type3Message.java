...
import jcifsng.ntlmssp.av.AvFlags;
import jcifsng.ntlmssp.av.AvPair;
import jcifsng.ntlmssp.av.AvPairs;
import jcifsng.ntlmssp.av.AvSingleHost;
import jcifsng.ntlmssp.av.AvTargetName;
import jcifsng.ntlmssp.av.AvTimestamp;
import jcifsng.smb.NtlmUtil;
...
public class Type3Message extends NtlmMessage {
    ...
    public String toString () {
        ...
        return "Type3Message[domain=" + domainString + ",user=" + userString + ",workstation=" + workstationString + ",lmResponse="
                ...
                + jcifsng.util.Hexdump.toHexString(getFlags(), 8) + "]";
    }
