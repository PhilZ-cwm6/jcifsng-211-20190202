...
import jcifsng211.ntlmssp.av.AvFlags;
import jcifsng211.ntlmssp.av.AvPair;
import jcifsng211.ntlmssp.av.AvPairs;
import jcifsng211.ntlmssp.av.AvSingleHost;
import jcifsng211.ntlmssp.av.AvTargetName;
import jcifsng211.ntlmssp.av.AvTimestamp;
import jcifsng211.smb.NtlmUtil;
...
public class Type3Message extends NtlmMessage {
    ...
    public String toString () {
        ...
        return "Type3Message[domain=" + domainString + ",user=" + userString + ",workstation=" + workstationString + ",lmResponse="
                ...
                + jcifsng211.util.Hexdump.toHexString(getFlags(), 8) + "]";
    }
