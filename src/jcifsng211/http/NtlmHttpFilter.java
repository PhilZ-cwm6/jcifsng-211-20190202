...
import jcifsng211.Config;
import jcifsng211.config.PropertyConfiguration;
import jcifsng211.context.BaseContext;
import jcifsng211.netbios.UniAddress;
import jcifsng211.smb.NtStatus;
import jcifsng211.smb.NtlmChallenge;
import jcifsng211.smb.NtlmPasswordAuthentication;
import jcifsng211.smb.SmbAuthException;
import jcifsng211.smb.SmbException;
import jcifsng211.smb.SmbSessionInternal;
    ...
    protected NtlmPasswordAuthentication negotiate ( HttpServletRequest req, HttpServletResponse resp, boolean skipAuthentication )
        ...
        if ( msg != null && ( msg.startsWith("NTLM ") || ( offerBasic && msg.startsWith("Basic ") ) ) ) {
            ...
            try {
                ...
                log.warn("NtlmHttpFilter: " + ntlm.getName() + ": 0x" + jcifsng211.util.Hexdump.toHexString(sae.getNtStatus(), 8) + ": " + sae);
